                    ...
                    <!-- Add icons to the links using the .nav-icon class
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{url('BOD-Com-dashboard')}}" style="background: #600000;" class="nav-link active">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{url('bodcom/add')}}" style="background: #031273; color:#fff;" class="btn btn-block"><i class="fa-solid fa-plus"></i></a>
                            </h3>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="display: flex; gap: 5%;">
                                    ...
                                    <form class="icon delete" action="{{ route('committees.destroy', $committee->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
