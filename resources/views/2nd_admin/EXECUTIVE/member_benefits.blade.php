                  ...
                  <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><button type="button" class="btn btn-block bg-gradient-primary"><a href="{{url('coop_manuals/member_benefits/add')}}" style="color: white;">Add Membership Benefits</a></button></h3>
                        </div>
                        <div class="card-body">
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <a href="{{url('coop_manuals/member_benefits/edit')}}" class="icon edit">
