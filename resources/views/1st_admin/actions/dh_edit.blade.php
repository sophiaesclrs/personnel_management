                ...
                <form action="{{ route('dh.update', ['id' => $user->id]) }}" method="POST">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <option value="">{{ old('rights', $user->rights) }}</option>
                            <option value="Internal Audit" {{ old('rights', $user->rights) === 'Internal Audit' ? 'selected' : '' }}>Internal Audit</option>
                            <option value="Human Resource Department" {{ old('rights', $user->rights) === 'Human Resource Department' ? 'selected' : '' }}>Human Resource Department</option>
                            <option value="Marketing Department" {{ old('rights', $user->rights) === 'Marketing Department' ? 'selected' : '' }}>Marketing Department</option>
                            <option value="Area Manager Department" {{ old('rights', $user->rights) === 'Area Manager Department' ? 'selected' : '' }}>Area Manager Department</option>
                            <option value="Executive Department" {{ old('rights', $user->rights) === 'Executive Department' ? 'selected' : '' }}>Executive Department</option>
                          </select>
                        </div>
                    </div>
