        ...
        <aside style="background: #000;" class="main-sidebar elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-4 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                    <a href="#" style="font-size: 15px; text-transform: capitalize; font-weight: 400; color:white;" class="ml-2 d-block font-weight-bold">HR Head</a>
                    </div>
                </div>
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="{{ url ('hr-dashboard/members') }}" class="nav-link">
                                <i class="nav-icon fas fa-user-group"></i>
                                <p>MNMPC Members</p>
                            </a>
                        </li>
                        <li class="nav-item">
                          <a href="{{ url ('hr-dashboard/jobs') }}" style="background: #660000;" class="nav-link active">
                              <i class="nav-icon fas fa-laptop-file"></i>
                              <p>Job Lists</p>
                          </a>
                        </li>
                        <li class="nav-item">
                          <a href="{{ url ('hr-dashboard/available_jobs') }}" class="nav-link">
                              <i class="nav-icon fas fa-envelope-open-text"></i>
                              <p>Available Jobs</p>
                          </a>
                        </li>
                        <li class="nav-item">
                          <a href="{{ url ('hr-dashboard/bod_res') }}" class="nav-link">
                              <i class="nav-icon fas fa-folder-closed"></i>
                              <p> BOD Resolutions </p>
                          </a>
                        </li>

                        <li style="color: #747474;" class="nav-header">COOP BRANCHES</li>
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mt-3 mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Job Lists</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">job lists</a></li>
                ...
                <div class="card card-default card-info">
                    <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2 select2-primary" data-dropdown-css-class="select2-primary" style="width: 100%;">
                                        ...
                                        <option>Tibanga Main</option>
                                        <option>Bulua Branch</option>
                                        <option>Carmen Branch</option>
                                        <option>Cogon Branch</option>
                                        <option>Laguindingan Branch</option>
                                        <option>Manticao Branch</option>
                                        <option>Puerto Branch</option>
                                        <option>Pala-o Main</option>
                                        <option>Buru-un Branch</option>
                                        <option>Kiwalan Branch</option>
                                        <option>Poblacion Branch</option>
                                        <option>Suarez-Tominobo Branch</option>
                                        <option>Tubod Iligan Branch</option>
                                        <option>Butuan Branch</option>
                                        <option>Davao Main</option>
                                        <option>General Santos Branch</option>
                                        <option>Bacolod LDN Branch</option>
                                        <option>Maranding Branch</option>
                                        <option>Pagadian Branch</option>
                                        <option>Tubod LDN Branch</option>
                                        <option>San Francisco Branch</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="disabledInput" type="text" placeholder="MSU-IIT NMPC" disabled>
                                </div>
                            </div>
                        ...
                        <div class="col-12 mt-5">
                            <a href="{{ url ('hr-dashboard/jobs') }}" class="btn btn-danger">Cancel</a>
                            <a href="">
                                <input type="submit" value="Update Job" class="btn btn-warning float-right">
                            </a>
                        </div>
