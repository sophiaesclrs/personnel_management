                ...
                <div class="row mt-3 mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Business Directories</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                  ...
                  <div class="col-12">
                    <div class="card">
                      <div class="card-header">
                        <h3 class="card-title"><button type="button" class="btn btn-block bg-gradient-primary"><a href="{{ url ('membership/bdirectory/add') }}" style="color: white;">Add Business Directory</a></button></h3>
                      </div>
                      <!-- /.card-header -->
                      <div class="card-body">
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td style="display: flex; gap: 5%;">
                                  <a href="{{ url ('membership/bdirectory/edit') }}" class="icon edit">
                              ...
                              <tr>
                                ...
                                <td style="display: flex; gap: 5%;">
                                  <a href="actions/edit_news.php" class="icon edit">
                                    <button type="button" class="btn btn-warning">
                                      <i class="fas fa-pen-nib"></i>
                                    </button>
                                  </a>
