                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                              ...
                              <li class="nav-item">
                                  <a href="{{url('executive-dashboard/bod_resolution/pakigsayud')}}" style="background: #660000;" class="nav-link active">
                        ...
                        <li class="nav-item">
                          ...
                          <ul class="nav nav-treeview">
                              ...
                              <li class="nav-item">
                                  <a href="{{url('executive-dashboard/coop_manuals/member_benefits')}}" class="nav-link">
                                      <i class="far fa-circle nav-icon"></i>
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mt-3 mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Pakigsayud</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="">BOD Resolutions Repo</a></li>
                            <li class="breadcrumb-item active">Pakigsayud</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                  ...
                  <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><button type="button" class="btn btn-block bg-gradient-primary"><a href="{{url('bodres/pakigsayud/add')}}" style="color: white;">Add Pakigsayud</a></button></h3>
                        </div>
                        <div class="card-body">
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <button style="width: 130px; font-size: 12px;    " type="button" class="btn btn-block bg-gradient-secondary btn-sm">Tags: <span>Something here</span></button>
                                    </td>
                                    <td>2023-04-30</td>
                                    <td><span class="badge">Confirmed</span></td>
                                    <td>
                                    <p style="font-size: 14px; font-weight: bold;">Alexander Pierce</p>
                                    <p class="time">March 04, 2023</p>
                                    </td>
                                    <td style="display: flex; gap: 5%;">
                                    <a href="{{url('bodres/pakigsayud/edit')}}" class="icon edit">
                                ...
                                <tr>
                                    ...
                                    <td>2023-04-30</td>
                                    <td><span class="badge badge-amen">Amended</span></td>
                                    <td>
                                    <p style="font-size: 14px; font-weight: bold;">Alexander Pierce</p>
                                    <p class="time">March 04, 2023</p>
                                    </td>
