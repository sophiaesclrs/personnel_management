                ...
                <div class="row mt-3 mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="">Cash & Loans</a></li>
            ...
            <div class="card card-default card-info">
                        <div class="card-body">
                            ...
                            <div class="col-12 mt-5">
                                <a href="{{url('executive-dashboard/coop_manuals/cash_and_loans')}}" class="btn btn-danger">Cancel</a>
                                <a href="">
                                    <input type="submit" value="Add Loan" class="btn btn-success float-right">
                                </a>
                            </div>
