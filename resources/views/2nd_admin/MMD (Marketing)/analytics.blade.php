                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="nav nav-treeview">
                                        <li class="nav-item">
                                            <a href="{{ url ('mmd-dashboard/reports/analytics')}}" style="background: #660000;" class="nav-link active">
                        ...
                        <div class="card-body">
                            <div class="d-flex">
                                <p class="d-flex flex-column">
                                    <span class="text-bold text-lg">246k</span>
                            ...
                            <div class="d-flex flex-row justify-content-end">
                                <span class="mr-2"><i class="fas fa-square text-primary"></i> Clients </span>
                                <span> <i class="fas fa-square text-gray"></i> Assisted Clients </span>
                            </div>
                        </div>
                    </div>
                </div>
