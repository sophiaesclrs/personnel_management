                ...
                <div class="row mt-3 mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">News & Events Archive</a></li>
                ...
                <div class="card card-default card-info">
                    <div class="card-body">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2 select2-primary" data-dropdown-css-class="select2-primary" style="width: 100%;">
                                        <option selected="selected">Slide Order</option>
                                        <option>1</option>
                                        <option>2</option>
                                        <option>3</option>
                                        <option>4</option>
                        ...
                        <div class="col-12 mt-5">
                            <a href="{{ url ('mmd-dashboard/news')}}" class="btn btn-danger">Cancel</a>

                            <a href="">
                                <input type="submit" value="Add News & Events" class="btn btn-success float-right">
                            </a>
                        </div>
