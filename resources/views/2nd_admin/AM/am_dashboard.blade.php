        ...
        <nav style="background: #031273; color: white;" class="main-header navbar navbar-expand">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="head-text nav-item d-none d-sm-inline-block">
                        ...
                        <p>shown here are the data reports for the <span>AM-based</span> modules</p>
                    </li>
                </ul>
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="{{ url ('am-dashboard')}}" style="background: #660000;" class="nav-link active">
