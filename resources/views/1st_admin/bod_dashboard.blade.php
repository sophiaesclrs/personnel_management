                ...
                <!-- Add icons to the links using the .nav-icon class
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{url('BOD-dashboard')}}" style="background: #600000;" class="nav-link active">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{url('bod/add')}}" style="background: #031273; color:#fff;" class="btn btn-block"><i class="fa-solid fa-plus"></i></a>
                            </h3>
                          ...
                          <table id="example1" class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $BOD->name }}</td>
                                    <td>{{ $BOD->position }}</td>
                                    <td><span>{{ $BOD->period }}</span></td>

                                    <td>
                                        <img src="{{ asset('storage/' . $BOD->photo) }}"  style="width: 48px;" class="img-circle">
                                    </td>
                                    ...
                                    <td style="display: flex; gap: 5%;">
                                        ...
                                        <form class="icon delete" action="{{ route('bod_delete', $BOD->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
