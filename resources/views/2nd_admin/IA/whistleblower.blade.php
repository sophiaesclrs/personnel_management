            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="{{ url ('ia-dashboard/whistleblower') }}" style="background: #660000;" class="nav-link active">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <table id="example1" class="text-center table table-hover">
                                    <thead>
                                        <tr>
                                            <th>Reported by</th>
                                            <th>Full Name</th>
