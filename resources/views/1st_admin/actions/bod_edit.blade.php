        ...
        <section class="content mb-5">
            <div class="container-fluid">
                <div class="card card-default card-info">
                    ...
                    @endif
                    <form action="{{ route('bod.update', ['id' => $BOD->id]) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control" value="{{ old('name', $BOD->name) }}">
                                    @error('name')
                        ...
                        <div class="col-12 mt-5">
                            ...
                            <a href="">
                            @if($errors->any())
                                <input type="submit" value="Update" class="btn btn-warning float-right" disabled>
                            @else
