          ...
          <div class="card card-default card-info">
                    <div class="card-body">
                        ...
                        <div class="col-12 mt-5">
                            <a href="{{url('executive-dashboard/coop_manuals/savings')}}" class="btn btn-danger">Cancel</a>
                            <a href="">
                                <input type="submit" value="Add Savings" class="btn btn-success float-right">
                            </a>
                        </div>
