                  ...
                  <div class="col-12">
                    <div class="card">
                      <div class="card-header">
                        <h3 class="card-title"><button type="button" class="btn btn-block bg-gradient-primary"><a href="{{url('jobs/add')}}" style="color: white;">Add Job</a></button></h3>
                      </div>
                      <!-- /.card-header -->
                      <div class="card-body">
                          <table id="example1" class="table table-bordered table-hover">
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td>Pala-o Branch [Head Office]</td>
                                <td>MSU-IIT NMPC</td>
                                <td>July 18, 2023</td>
                                <td>August 19, 2023</td></td>
                                <td><span class="badge badge-blue">Draft</span></td>
                                <td>
                                  <a href="{{url('jobs/edit')}}" class="icon edit">
