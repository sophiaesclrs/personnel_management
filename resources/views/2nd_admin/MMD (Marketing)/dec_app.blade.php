...
<head>
  ...
  <style>
    ...
    *{
    ...
    .badge-yellow{ background: #fcd12a; color: black; }
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="nav nav-treeview">
                                        ...
                                        <li class="nav-item">
                                            <a href="{{ url ('mmd-dashboard/membership/dec_app')}}" style="background: #660000;" class="nav-link active">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mt-3 mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Declined Appointments</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="#">Membership</a></li>
                            <li class="breadcrumb-item active">Declined Appointments</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                          ...
                          <table id="example1" class="table table-bordered table-hover">
                            ...
                            <tbody>
                              ...
                              <tr>
                                <td>ABC123</td>
                                <td>Tibanga-Main</td>
                                <td>Pre-membership</td>
                                <td>12-10-23</td>
                                <td>09:15:34</td>
                                <td>10:16:24</td>
                                <td><span class="badge badge-amen">Declined</span></td>
                                <td>12-10-23 09:15:34</td>
                                <td>12-10-23 09:15:34</td>
                              </tr>
