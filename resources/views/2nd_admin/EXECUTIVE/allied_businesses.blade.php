                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                          ...
                          <ul class="nav nav-treeview">
                              ...
                              <li class="nav-item">
                                  <a href="{{url('executive-dashboard/coop_manuals/allied_businesses')}}" style="background: #660000;" class="nav-link active">
                  ...
                  <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><button type="button" class="btn btn-block bg-gradient-primary"><a href="{{url('coop_manuals/allied_businesses/add')}}" style="color: white;">Add Business Partner</a></button></h3>
                        </div>
                        <div class="card-body">
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <a href="{{url('coop_manuals/allied_businesses/edit')}}" class="icon edit">
