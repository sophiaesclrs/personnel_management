            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card-header">
                            ...
                            <a href="{{url('dh/add')}}" style="background: #031273; color:#fff;" class="btn btn-block"><i class="fa-solid fa-plus"></i></a>
                            </h3>
                      ...
                      <table id="example1" class="table table-hover">
                        ...
                        <tbody>
                            @foreach($DH as $key => $departmentHead)
                                <tr>
                                     <td>{{ $key + 1 }}</td>
                                    ...
                                    <td style="display: flex; gap: 5%;">
                                     ...
                                     <form class="icon delete" action="{{ route('dh.delete', $departmentHead->id) }}" method="POST">
                                      @csrf
                                      @method('DELETE')
