                ...
                <div class="row mt-3 mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="">Pakigsayud</a></li>
                            <li class="breadcrumb-item active">Add Pakigsayud</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
          ...
          <div class="card card-default card-info">
                    <div class="card-body">
                        ...
                        <div class="col-12 mt-5">
                            <a href="{{url('executive-dashboard/bod_resolution/pakigsayud')}}" class="btn btn-danger">Cancel</a>
                            <a href="">
                                <input type="submit" value="Add Pakigsayud" class="btn btn-success float-right">
                            </a>
                        </div>
