                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="nav nav-treeview">
                                        ...
                                        <li class="nav-item">
                                            <a href="{{ url ('mmd-dashboard/reports/reg_clients')}}" style="background: #660000;" class="nav-link active">
                                                <i class="fas fa-circle nav-icon"></i>
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mt-3 mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Registered Clients</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                          ...
                          <table id="example1" class="table table-bordered table-hover">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td>09:15:34</td>
                                <td>10:16:24</td>
                                <td><span class="badge badge-yellow">Passed</span></td>
