                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                              ...
                              <li class="nav-item">
                                  <a href="{{url('executive-dashboard/bod_resolution/dlforms')}}" style="background: #660000;" class="nav-link active">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mt-3 mb-2">
                    <div class="col-sm-6">
                    <h3 class="m-0"><button type="button" style="width:100px; background: #031273; color: white;" class="btn btn-block"><a href="" style="color: #fff;">Add Form</a></button></h3>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
            ...
            <!-- Info boxes -->
              <div class="row row-cols-2">
                    <div class="col">
                        ...
                        <a href="#" style="color: black;" class="small-box-footer"> Download Forms <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
