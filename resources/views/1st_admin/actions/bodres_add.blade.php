...
<div class="row">
    ...
    <form id="addResolutionForm" class="form-group" method="post" action="{{ route('store_resolution') }}">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="input-group date" id="reservationdate" data-target-input="nearest">
                            <input type="text" name="res_date"  class="form-control datetimepicker-input" placeholder="<?php
                                    date_default_timezone_set('Asia/Manila');
                                    $today = date('m-d-Y');
                                    echo $today;
                                ?>" disabled  />
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="encoded_by_name">Encoded by</label>
                        <input type="text" id="encoded_by_name" name="encoded_by_name" aria-label="Name" class="form-control" readonly value="{{ Auth::check() ? Auth::user()->name : '' }}">
                    </div>
                </div>
